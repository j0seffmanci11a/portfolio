  ...
  return (
    <section>
      ...
      <div className="project">
        <h3>Todo App</h3>
        <img src="assets/todo.png" alt="Todo App" style={{width: '500px', height:'auto'}} />
      ...
      <div className="project">
        <h3>Exercise App</h3>
        <img src="assets/exercise.png" alt="Exercise App" style={{width: '500px', height:'auto'}}/>
      ...
      <div className="project">
        <h3>Quiz App</h3>
        <img src="assets/quiz.png" alt="Quiz App" style={{width: '500px', height:'auto'}}/>
